...
namespace SmartStore.Admin.Models.Customers
{
    ...
    public class CustomerModel : TabbableModel
    {
		...
		[SmartResourceDisplayName("Account.Fields.StokistCommision")]
		...
		public bool AllowManageCustomers { get; set; }
		...
		[SmartResourceDisplayName("Account.Customers.Customers.SolidTrustPayAcc")]
		public string SolidTrustPayAcc { get; set; }

		public bool CoinPaymentEnabled { get; set; }
		[SmartResourceDisplayName("Account.Customers.Customers.BitcoinAddressAcc")]
		public string BitcoinAddressAcc { get; set; }

		public bool PayeerEnabled { get; set; }
		[SmartResourceDisplayName("Account.Customers.Customers.PayeerAcc")]
		public string PayeerAcc { get; set; }

		public bool PMEnabled { get; set; }
		[SmartResourceDisplayName("Account.Customers.Customers.PMAcc")]
		public string PMAcc { get; set; }

		public bool PayzaEnabled { get; set; }
		[SmartResourceDisplayName("Account.Customers.Customers.PayzaAcc")]
		public string PayzaAcc { get; set; }

		public bool AdvanceCashEnabled { get; set; }
		[SmartResourceDisplayName("Account.Customers.Customers.AdvanceCashAcc")]
		public string AdvanceCashAcc { get; set; }

		public bool UPIPaymentEnabled { get; set; }
		[SmartResourceDisplayName("Account.Customers.Customers.UPIPaymentNumber")]
